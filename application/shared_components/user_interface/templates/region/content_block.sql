...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7945916542865788)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7946207585865788)
,p_plug_template_id=>wwv_flow_api.id(7945916542865788)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7946542949865788)
,p_plug_template_id=>wwv_flow_api.id(7945916542865788)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7946886108865788)
,p_plug_template_id=>wwv_flow_api.id(7945916542865788)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7947168865865788)
,p_plug_template_id=>wwv_flow_api.id(7945916542865788)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7947494826865788)
,p_plug_template_id=>wwv_flow_api.id(7945916542865788)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7947732072865788)
,p_plug_template_id=>wwv_flow_api.id(7945916542865788)
,p_name=>'Sub Regions'
