...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7924965668865779)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7925254224865779)
,p_plug_template_id=>wwv_flow_api.id(7924965668865779)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7925566630865779)
,p_plug_template_id=>wwv_flow_api.id(7924965668865779)
,p_name=>'Sub Regions'
