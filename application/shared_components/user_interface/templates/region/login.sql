...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7969760509865799)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7970069849865800)
,p_plug_template_id=>wwv_flow_api.id(7969760509865799)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7970348016865800)
,p_plug_template_id=>wwv_flow_api.id(7969760509865799)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7970682553865800)
,p_plug_template_id=>wwv_flow_api.id(7969760509865799)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7970977274865800)
,p_plug_template_id=>wwv_flow_api.id(7969760509865799)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7971271614865800)
,p_plug_template_id=>wwv_flow_api.id(7969760509865799)
,p_name=>'Sub Regions'
