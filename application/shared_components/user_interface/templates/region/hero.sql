...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(7950141157865789)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7950494680865792)
,p_plug_template_id=>wwv_flow_api.id(7950141157865789)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7950705496865792)
,p_plug_template_id=>wwv_flow_api.id(7950141157865789)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7951021657865792)
,p_plug_template_id=>wwv_flow_api.id(7950141157865789)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(7951373320865792)
,p_plug_template_id=>wwv_flow_api.id(7950141157865789)
,p_name=>'Sub Regions'
